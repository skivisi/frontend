    ...
    <div className="w-full">
      ...
      <div className="flex justify-center mt-10">
        ...
        <div className="mr-5">
          <button
            onClick={mock}
            className=" w-32 bg-blue-700 text-white text-xl font-black border-x-4 border-t-4 border-blue-300 rounded-t-2xl px-5 py-3"
          >
            スペック
          </button>
        </div>
        <div className="ml-5">
          <button
            onClick={mock}
            className=" w-32 bg-blue-950 text-zinc-500 text-xl font-black border-x-4 border-t-4 border-zinc-500 rounded-t-2xl px-5 py-3"
          >
            スキル
          </button>
        </div>
